package org.ahmedmeid.jsontojavaclass;
...
public class JsonToJavaClassConversion {
    ...
    public static void main(String[] args) {
        String packageName = "com.ahmedmeid.fleet.service.dto";
        String basePath = "src/main/resources";
        File inputJson = new File(basePath + File.separator + "subscribeToChanges.json");
