...
public class Notification {
    ...
    public boolean equals(Object other) {
        ...
        return (((this.http == rhs.http)||((this.http!= null)&&this.http.equals(rhs.http)))&&((this.additionalProperties == rhs.additionalProperties)||((this.additionalProperties!= null)&&this.additionalProperties.equals(rhs.additionalProperties))));
    }
