...
public class CreateEntity {
    ...
    public boolean equals(Object other) {
        ...
        return ((((((this.regNo == rhs.regNo)||((this.regNo!= null)&&this.regNo.equals(rhs.regNo)))&&((this.vin == rhs.vin)||((this.vin!= null)&&this.vin.equals(rhs.vin))))&&((this.id == rhs.id)||((this.id!= null)&&this.id.equals(rhs.id))))&&((this.additionalProperties == rhs.additionalProperties)||((this.additionalProperties!= null)&&this.additionalProperties.equals(rhs.additionalProperties))))&&((this.type == rhs.type)||((this.type!= null)&&this.type.equals(rhs.type))));
    }
